...
### [Part 1](https://github.com/CarollCheng/Cat-Dog-Classifier/blob/master/CatDogClassifier_Part_1.ipynb)
...
### [Part 2](https://github.com/CarollCheng/Cat-Dog-Classifier/blob/master/CatDogClassifier_Part_2_batch.ipynb)
Neural Network performance is assessed by selecting and reviewing different learning rates and batch sizes.

### [Part 3](https://github.com/CarollCheng/Cat-Dog-Classifier/blob/master/CatDogClassifier_Part_3.ipynb)
In this section, we examined the number of layers and hidden layer neurons in different states.

### [Part 4](https://github.com/CarollCheng/Cat-Dog-Classifier/blob/master/CatDogClassifier_Part_4.ipynb)
...
### [Part 5](https://github.com/CarollCheng/Cat-Dog-Classifier/blob/master/CatDogClassifier_Part_5.ipynb)
